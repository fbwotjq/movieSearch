...
@Controller
public class OstDetailSearchController {
	// 실시간 검색어 화면 출력 여부 체크
    ...
    /** 인명 상세 페이지 이동 */
    @RequestMapping(value = "/moveOstSearch")
    public String artMoveSearch(HttpServletRequest request, Model model) {
        return "/wisenut/detail/ostDetailSearch";
    }

	@RequestMapping(value = "/ostSearch")
	public String ostSearch(HttpServletRequest request, Model model) {
