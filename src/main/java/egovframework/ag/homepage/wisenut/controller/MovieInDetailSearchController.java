...
@Controller
public class MovieInDetailSearchController {
	// 실시간 검색어 화면 출력 여부 체크
    ...
    /** 인명 상세 페이지 이동 */
    @RequestMapping(value = "/moveMovieInSearch")
    public String artMoveSearch(HttpServletRequest request, Model model) {

        return "/wisenut/detail/movieInDetailSearch";
    }

	@RequestMapping(value = "/movieInSearch")
	public String inSearch(HttpServletRequest request, Model model) {
