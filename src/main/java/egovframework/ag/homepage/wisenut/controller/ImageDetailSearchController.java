...
@Controller
public class ImageDetailSearchController {
	// 실시간 검색어 화면 출력 여부 체크
    ...
    /** 인명 상세 페이지 이동 */
    @RequestMapping(value = "/moveImageSearch")
    public String artMoveSearch(HttpServletRequest request, Model model) {
        return "/wisenut/detail/imageDetailSearch";
    }

	@RequestMapping(value = "/imageSearch")
	public String imageSearch(HttpServletRequest request, Model model) {
