...
@Controller
public class ScenarioDetailSearchController {
	// 실시간 검색어 화면 출력 여부 체크
    ...
    /** 인명 상세 페이지 이동 */
    @RequestMapping(value = "/moveScenarioSearch")
    public String artMoveSearch(HttpServletRequest request, Model model) {
        return "/wisenut/detail/scenarioDetailSearch";
    }

	@RequestMapping(value = "/scenarioSearch")
	public String scenarioSearch(HttpServletRequest request, Model model) {
