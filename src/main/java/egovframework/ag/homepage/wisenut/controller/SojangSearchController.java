...
@Controller
public class SojangSearchController {
	// 실시간 검색어 화면 출력 여부 체크
	...
	@RequestMapping(value = "/sojangSearch", method={RequestMethod.POST, RequestMethod.GET})
	public String sojangSearch(HttpServletRequest request, Model model) {
...
//                exquery = "<WRITER:" + writer + ">";
        ...
        if(collection.equals("ALL")) { //통합검색인 경우
            ...
            // 필름/D시네마, 비디오, 시나리오/콘티, 도서/논문, 음반, 심의서류, 박물류, 전단/보도자료/기타자료
            collections = new String[] {"kmDCFILM","kmVIDEO","kmSCENARIO","kmBOOK","kmOST","kmCENSOR","kmEQUIPMENT","kmFLYER"};
        } else {                        //개별검색인 경우
