...
@Controller
public class DCFilmDetailSearchController {
	// 실시간 검색어 화면 출력 여부 체크
    ...
    /** 필름/D시네마 상세 페이지 이동 */
    @RequestMapping(value = "/moveFilmSearch")
    public String artMoveSearch(HttpServletRequest request, Model model) {
        return "/wisenut/detail/dcFilmDetailSearch";
    }

	@RequestMapping(value = "/filmSearch")
	public String filmSearch(HttpServletRequest request, Model model) {
