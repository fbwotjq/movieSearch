...
PDFJS.imageResourcesPath = '/resources/viewer/pdf/web/images/';
PDFJS.workerSrc = '/resources/viewer/pdf/build/pdf.worker.js';
PDFJS.cMapUrl = '/resources/viewer/pdf/web/cmaps/';
...
function webViewerInitialized() {
  ...
  */
  ...
  if (file && file.lastIndexOf('file:', 0) === 0) {
    ...
    try {
      xhr.open('GET', "/history/download?dFileSeq=uUY5Z7r36HrD5lsBAzj2cQ==&dFileOrder=GOqpE7nmPUOd0Ws57Gct3g==");
