            ...
            <section id="fieldset">
                ...
                <div class="mTab2">
                    <div class="owl-carousel owl-theme" id="db-tab-search1">
                        ...
                        <div class="item"><a href="DB030302.html" class="selected">비디오</a></div>
                    ...
                    <div class="mTab3">
                        <ul>
                            ...
                            <li class="selected"><a href="DB030302.html">비디오</a></li>
                ...
                <div class="mDBSearch1">
                    <dl>
                        ...
                        <dd class="select">
                            <input type="text" id="labelNation" title="제작국가" placeholder="제작국가">
                        ...
                        <dt class="title">비디오매체정보</dt>
                        <dt class="check mt2"><label for="labelStandard">비디오규격</label></dt>
                        <dd class="check mt2">
                            <div class="asset">
                                <label><input type="checkbox" name="" id="labelStandard"> <span class="label">전체</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">Blue-ray</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">DVD</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">VHS</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">HDCAM</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">Digi-Betecam</span></label>
                            </div>
                        </dd>
                        <dt class="mt3"><label for="labelFilm">비디오제조/판매원</label></dt>
                        <dd class="mt3">
                            <input type="text" id="labelKeyword" title="비디오제조/판매원" placeholder="직접입력">
                        </dd>
                        <dt><label for="labelYear">제작년도</label></dt>
                        <dd class="date">
                            <div class="col">
                        ...
                        <dt><label for="labelStandard">관람기준</label></dt>
                        <dd>
                            <div class="select-box w1">
                                <select name="" id="" class="select-tric">
                        ...
                        <dt class="check line"><label for="labelLanguage">언어</label></dt>
                        <dd class="check line">
                            <div class="asset">
                                <label><input type="checkbox" name="" id="labelLanguage"> <span class="label">전체</span></label>
                            </div>
                            <div class="asset">
