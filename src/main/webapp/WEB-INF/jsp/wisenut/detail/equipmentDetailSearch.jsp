            ...
            <section id="fieldset">
                ...
                <div class="mTab2">
                    <div class="owl-carousel owl-theme" id="db-tab-search1">
                        ...
                        <div class="item"><a href="DB030309.html" class="selected">박물류</a></div>
                    </div>
                    ...
                    <div class="mTab3">
                        <ul>
                            ...
                            <li class="selected"><a href="DB030309.html">박물류</a></li>
                        </ul>
                    </div>
                    <!-- //tab forPc and mobile 상세메뉴 -->
                </div>
                ...
                <div class="mDBSearch1">
                    <dl class="mt1">
                        <dt><label for="labelMusicName">박물류명</label></dt>
                        <dd class="name">
                            <input type="text" id="labelMusicName" title="박물류명" placeholder="직접입력">
                        </dd>
                        <dt><label for="labelAboutName">관련영화명</label></dt>
                        <dd>
                            <input type="text" id="labelAboutName" title="관련영화명" placeholder="직접입력">
                        </dd>
                        <dt class="check"><label for="labelMusicDiv">박물류 종류</label></dt>
                        <dd class="check">
                            <div class="asset">
                                <label><input type="checkbox" name="" id="labelMusicDiv"> <span class="label">전체</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">영화기자재</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">영화소품</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">기타박물류</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">영화홍보물</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">기념품</span></label>
                            </div>
                        </dd>
