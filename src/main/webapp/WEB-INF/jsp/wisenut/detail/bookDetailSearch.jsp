...
<form id="searchForm" name="searchForm" method="post">
    ...
    <input type="hidden" id="tabName" name="tabName" value="<c:out value='${tabName}'/>"/>
            ...
            <section id="fieldset">
                ...
                <div class="mTab2">
                    <div class="owl-carousel owl-theme" id="db-tab-search1">
                        ...
                        <div class="item"><a href="DB030306.html" class="selected">도서/논문</a></div>
                    ...
                    <div class="mTab3">
                        <ul>
                            ...
                            <li class="selected"><a href="DB030306.html">도서/논문</a></li>
                ...
                <div class="mDBSearch1">
                    <dl class="mt1">
                        <dt><label for="labelBookName">도서/논문명</label></dt>
                        <dd class="name">
                            <div class="col1"><input type="text" id="labelBookName" title="도서/논문명" placeholder="직접입력"></div>
                        ...
                        <dt><label for="labelWriter">저자/역자</label></dt>
                        <dd class="name">
                            <div class="col1"><input type="text" id="labelWriter" title="저자/역자" placeholder="직접입력"></div>
                            <div class="col2 select-box">
                                <select name="" id="" class="select-tric">
                                    <option value="">AND</option>
                                    <option value="">OR</option>
                        ...
                        <dt><label for="labelKeyword">키워드/목차/초록</label></dt>
                        <dd class="name">
                            <div class="col1"><input type="text" id="labelKeyword" title="키워드/목차/초록" placeholder="직접입력"></div>
                            <div class="col2 select-box">
                                <select name="" id="" class="select-tric">
                                    <option value="">AND</option>
                                    <option value="">OR</option>
                        ...
                        <dt><label for="labelPublish">발행처</label></dt>
                        <dd>
                            <input type="text" id="labelYear" title="발행처" placeholder="직접입력">
                        </dd>
                        <dt class="check mt2"><label for="labelPublish2">발행국사</label></dt>
                        <dd class="check mt2">
                            <div class="asset">
                                <label><input type="checkbox" name="" id="labelPublish2"> <span class="label">전체</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">국내</span></label>
                            </div>
                            <div class="asset">
                                <label><input type="checkbox" name="" id=""> <span class="label">국외</span></label>
                            </div>
                        </dd>
                        <dt><label for="labelYear">발행년도</label></dt>
                        <dd class="date mb0">
                            <div class="col">
                                <span class="c1"><input type="text" id="labelYear" title="발행년도" placeholder="범위 직접입력"></span>
                                <span class="c2">년</span>
                            </div>
                            <div class="bar">~</div>
                            <div class="col">
                                <span class="c1"><input type="text" title="발행년도" placeholder="범위 직접입력"></span>
                                <span class="c2">년</span>
                            </div>
                        </dd>
