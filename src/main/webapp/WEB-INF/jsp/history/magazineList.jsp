        ...
        <section id="fieldset">
            ...
            <div class="mSearch">
                ...
                <div class="dbinfo-radio selector-wrap horizontal">
                    ...
                    <div class="asset type2">
                        <label><input type="radio" name="searchType" id="searchType_BIRTH_YEAR" value="BIRTH_YEAR" <c:if test="${paramMap.searchType == 'BIRTH_YEAR'}">checked="checked"</c:if>> <span class="label">발행년도</span></label>
                    </div>
                </div>
            </div>
            <!-- //search -->
            ...
            <!-- sort -->
            <div class="mSort1">
                <h4>영화잡지 (<span class="em weighty"><c:out value="${pageListVo.totalCount }"/></span>)</h4>
                <div class="rt">
...
function fcnDetail(pArchivesSeq) {
	formSubmit("form1", "<c:url value="/history/magazine/"/>" + pArchivesSeq);
}
</script>