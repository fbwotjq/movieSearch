...
<div id="contents">
	<div class="breadcrumb">
		<ul>
			...
			<li class="located"><a href="<c:out value='/member/findPass'/>">비밀번호 찾기</a></li>
		</ul>
	</div>
	<div class="container">
		<div class="top-area">
			...
			<fieldset>
				...
				<div class="confirm">
					<div class="confirm-box">
						<a href="javascript:fnCheckPerson('niceForm');"><span>안심본인인증</span><span>본인명의 휴대전화, 범용공인인증서로 본인인증</span><i class="ico-moveright"></i></a>
					</div>
					<div class="confirm-box">
						<a href="javascript:fnCheckIpin('niceForm');"><span>공공 I-PIN 인증</span><span>인터넷 상에서 신분 확인을 할 수 있는 식별</span><span> 번호로 본인인증</span><i class="ico-moveright"></i></a>
					</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		//design
		$("#body").addClass("login");
		$("#wrap").addClass("confirm-personal confirm-personal-pw");
	...
	function callbackCheckPersonResult(pParamJsonStr) {
		...
		formSubmit("form2", "<c:url value='/member/findPass/result'/>");
	}
