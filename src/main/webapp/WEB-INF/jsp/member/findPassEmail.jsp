            ...
            <fieldset class="fieldset">
                ...
                <section>
                    <div class="area">
                        <div class="field">
                            <div class="label">
                                <label for="userId">아이디 <span class="em weighty">*</span></label>
                            </div>
                            <div class="insert">
                        ...
                        <div class="field">
                            <div class="label">
                                <label for="userName">이름 <span class="em weighty">*</span></label>
                            </div>
                            <div class="insert">
                                <div class="insert-multi with-radio">
                                    <div class="box">
    ...
    $(document).ready(function() {
        ...
        $("#form1").validate({
            submitHandler: function(form) {
                formSubmit("form1", "<c:url value='/member/findPass/email/result'/>");
            }
            ,rules: {
