	...
	<div class="container">
		...
		<div class="regi-menu">
			<ul>
				...
				<li class="selected"><a href="javascript:void(0);"><span>Step2</span><span>약관동의</span></a></li>
				...
				<div class="agreeterm">
						...
						<div class="selector-wrap">
							<div class="asset">
								<label><div class="checker">
										<span><input type="checkbox" id="chkAll" name="chkAll"></span>
						...
						<div class="selector-wrap horizontal">
							<div class="asset">
								<label><div class="radio">
										<span><input type="radio" name="agre01" id="agre01_Y" value="1"></span>
									</div> <span class="label">동의합니다.</span></label>
							</div>
							<div class="asset">
								<label><div class="radio">
										<span><input type="radio" name="agre01" id="agre01_N" value="0"></span>
									</div> <span class="label">동의하지 않습니다.</span></label>
							</div>
						</div>
						<span class="em warning comment-line" id="error-agre01"></span>
					</div>
					<div class="agreeterm-terms member-priacy">
						...
						<div class="selector-wrap horizontal">
							<div class="asset">
								<label><div class="radio">
										<span><input type="radio" name="agre02" id="agre02_Y" value="1"></span>
									</div> <span class="label">동의합니다.</span></label>
							</div>
							<div class="asset">
								<label><div class="radio">
										<span><input type="radio" name="agre02" id="agre02_N" value="0"></span>
									</div> <span class="label">동의하지 않습니다.</span></label>
							</div>
						</div>
						<span class="em warning comment-line" id="error-agre02"></span>
					</div>
					<div class="btn-next btn-group large">
						<button id="btnNext"class="btn large weighty" disabled="disabled" onclick="nextStep();">다음</button>
					</div>
				</div>
			</section>
		</form>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#chkAll").bind("change", function() {
			...
			if (chkAllVal) {
				$("input:radio[name*='agre0']:input[value='1']").prop("checked", "checked");
		...
		$("input:radio[name*='agre0']").bind("change", function() {
			var agreeCheckLen = $("input:radio[name*='agre0']:input[value='1']:checked").length;
        ...
        $("#form1").validate({
            rules: {
            	agre01: { required: true, min: 1 }
               ,agre02: { required: true, min: 1 }
            }
            ,messages: {
            	agre01: { required: "한국영상자료원/KMDb회원약관에 동의 해 주셔야 가입 할 수 있습니다.", min: "한국영상자료원/KMDb회원약관에 동의 해 주셔야 가입 할 수 있습니다."}
               ,agre02: { required: "개인정보 수집 및 이용안내에 동의 해 주셔야 가입 할 수 있습니다.", min: "한국영상자료원/KMDb회원약관에 동의 해 주셔야 가입 할 수 있습니다." }
            }
	...
	function nextStep() {
		...
		formSubmit("form1", "/member/join/step3");
	}
</script>