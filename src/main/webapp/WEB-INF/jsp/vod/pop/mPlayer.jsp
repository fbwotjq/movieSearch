	...
	<div class="mLayer1">
		...
		<div class="layerBg">
			...
			<div class="cont">
				<!-- list -->
				<div class="mTitle5">
					<strong class="tit"><c:out value="${result.mulTitle}"/> : <c:out value="${result.titleSub}"/>[<c:out value="${result.titleEtc}"/>]</strong>
					<span class="gRt">관리번호: <c:out value="${result.fileNo}"/></span>
				</div>
				<div class="mList13">
					<ul>
					<li class="col2">
						<span class="tit">상영구분</span>
						<span class="txt"><c:out value="${result.mscreenClssNm}"/></span>
					</li>
					<li class="col2">
						<span class="tit">관람기준</span>
						<span class="txt"><c:out value="${result.levelClssNm}"/></span>
					</li>
					<li class="col2">
						<span class="tit">언어</span>
						<span class="txt"><c:out value="${result.language}"/></span>
					</li>
					<li class="col2">
						<span class="tit">상영시간</span>
						<span class="txt"><c:out value="${result.runtime}"/></span>
					</li>
					<li class="col2">
						<span class="tit">색채</span>
						<span class="txt"><c:out value="${result.colorClssNm}"/></span>
					</li>
					<li class="col2">
						<span class="tit">내용</span>
						<span class="txt"> <c:out value="${result.plot}"/></span>
					</li>
					<li class="clear">
						<span class="tit">프레임 크기</span>
						<span class="txt"><c:out value="${result.hSize}"/> X <c:out value="${result.vSize}"/></span>
					</li>
					</ul>
				</div>
				<!-- //list -->
