...
<script type="text/javascript">
    ...
    var ONLINE_ARCHIVES_PATH = UPLOAD_WEB_PATH+"<%= Constant.ONLINE_ARCHIVES_PATH%>";
	var KF_FILM_UPLOAD_PATH = "<%= Constant.KF_FILM_UPLOAD_PATH%>";
	var KF_FILM_IMAGE_PATH = "<%= Constant.KF_FILM_IMAGE_PATH%>";
	var MOVIE_POSTER_PATH = "<%= Constant.MOVIE_POSTER_PATH%>";
	var PERSON_IMG_PATH2 = "<%= Constant.PERSON_IMG_PATH2%>";
